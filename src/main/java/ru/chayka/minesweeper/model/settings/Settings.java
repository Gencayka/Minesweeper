...
public class Settings {
    ...
    private final int gameTimeMax;
    private final String leaderboardXmlFileName;
    ...
    private Settings() {
        ...
        try {
            ...
            gameTimeMax = getIntDefaultValue(DefaultSetting.GAME_TIME_MAX);
            leaderboardXmlFileName = getStringDefaultValue(DefaultSetting.LEADERBOARD_XML_FILE_NAME);
            defaultLeaderName = getStringDefaultValue(DefaultSetting.DEFAULT_LEADER_NAME);
            aboutText = getStringDefaultValue(DefaultSetting.ABOUT_TEXT);
            return;
        }

        gameTimeMax = tryToGetIntProperty(DefaultSetting.GAME_TIME_MAX, properties);
        leaderboardXmlFileName = tryToGetStringProperty(DefaultSetting.LEADERBOARD_XML_FILE_NAME, properties);
        defaultLeaderName = tryToGetStringProperty(DefaultSetting.DEFAULT_LEADER_NAME, properties);
        aboutText = tryToGetStringProperty(DefaultSetting.ABOUT_TEXT, properties);
    }
    ...
    public String getLeaderboardXmlFileName() {
        return leaderboardXmlFileName;
    }
